                ...
                <Row>
                    <Col lg={4}>
                        ...
                        <Link to={{pathname : '/learn', state : {topicId : currentLesson.topicId, lessonId : currentLesson.lessonId}}}>
                                <Button variant='info' style={{width : '280px', height : '50px'}}>
                                 Đi tới bài lý thuyết gần nhất
                                </Button>                                
                        </Link>
                        <br/>
                        <br/>
                        <Link to={{pathname : '/exercise', state : {exTopicId : currentLesson.exTopicId, exLessonId : currentLesson.exLessonId}}}>
                                <Button variant='info' style={{width : '280px', height : '50px'}}>
                                 Đi tới bài luyện tập gần nhất
                                </Button>                                
                        </Link>
